...
public class Solver {
    public static CarRecord solve(CaseRecord caseRecord) {
        ...
        int myStartTime = -1, myStartIntersection = -1, myEndIntersection = -1;
            ...
            for (int n0 = 0; n0 < n; n0++) {
                ...
                for (int t1 = t0; t1 <= x; t1++) {
                    ...
                    if (lastans != ans) {
                        ...
                        myEndIntersection = n - ans;
                        if (myEndIntersection < 0)
                            myEndIntersection = myStartIntersection - (ans % n);
                        lastans = ans;
                    }
        ...
        System.out.println("in " + myStartIntersection + " out " + myEndIntersection + " time " + ans + " timeIN " + myStartTime);
        return new CarRecord(myStartIntersection, myEndIntersection, myStartTime, true, ans);
    }
}
